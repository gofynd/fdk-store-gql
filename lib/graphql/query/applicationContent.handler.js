...
export function applicationContenthandler(applicationContent, dispatch, options) {
    const { announcements, blogs, seo_configuration, custom_fields, data_loaders, faq_categories, faqs, landing_page, navigations, pages, legal_information, support_information, tags, } = applicationContent;
    if (navigations) {
