...
export function loginWithEmailAndPasswordHandler(loginWithEmailAndPassword, dispatch, params, oldStore) {
    if (loginWithEmailAndPassword) {
        ...
        emitFPIEvent(FPI_EVENTS.LOG_IN, params, loginWithEmailAndPassword === null || loginWithEmailAndPassword === void 0 ? void 0 : loginWithEmailAndPassword.user, oldStore, dispatch);
    }
}
