...
export function transactOrder(paymentOptions, state) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (((_b = (_a = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _a === void 0 ? void 0 : _a.checkoutCart) === null || _b === void 0 ? void 0 : _b.success) && ((_c = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.aggregator) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === "juspay") {
            return orderInfo;
        }
        if ((_e = (_d = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _d === void 0 ? void 0 : _d.checkoutCart) === null || _e === void 0 ? void 0 : _e.success) {
            // Reset ordering store in case of successful checkout
            removeCookie("m_orderingStore");
            //get updated order info
            orderInfo = updateOrderInfo(currentPaymentGateway, (_f = orderInfo.data) === null || _f === void 0 ? void 0 : _f.checkoutCart, paymentOptions);
