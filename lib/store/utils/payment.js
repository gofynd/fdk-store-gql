...
export function transactOrder(paymentOptions, state) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.success) || ((_b = (_a = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _a === void 0 ? void 0 : _a.checkoutCart) === null || _b === void 0 ? void 0 : _b.success)) {
            // if juspay as payment gateway for card payment
...
function createOrder(paymentOptions) {
    var _a, _b, _c, _d;
    const currentModeOfPayment = Object.assign({ mode: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_mode, name: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_mode, payment: "required", payment_meta: {
            merchant_code: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.merchant_code,
            payment_gateway: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.aggregator,
            payment_identifier: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_identifier,
        } }, ((paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_extra_identifiers) ?
        {
            payment_extra_identifiers: paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_extra_identifiers,
        }
        : {}));
    let options = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ address_id: paymentOptions.address_id, billing_address_id: paymentOptions.billing_address_id, aggregator: paymentOptions.aggregator, merchant_code: paymentOptions.merchant_code, payment_mode: paymentOptions.payment_mode, callback_url: paymentOptions.callback_url, meta: paymentOptions.meta, payment_methods: ((_a = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_methods) === null || _a === void 0 ? void 0 : _a.length) > 1 ?
            paymentOptions.payment_methods
            : currentModeOfPayment }, (paymentOptions.id ? { id: paymentOptions.id } : {})), (paymentOptions.custom_meta ?
        ...
        : {})), (paymentOptions.billing_address ?
    ...
    if ((typeof navigation !== "undefined" && ((_b = navigation === null || navigation === void 0 ? void 0 : navigation.currentEntry) === null || _b === void 0 ? void 0 : _b.url)) ||
        ((_c = window === null || window === void 0 ? void 0 : window.location) === null || _c === void 0 ? void 0 : _c.href)) {
        let currentUrl = new URL((typeof navigation !== "undefined" && ((_d = navigation === null || navigation === void 0 ? void 0 : navigation.currentEntry) === null || _d === void 0 ? void 0 : _d.url)) ||
    ...
    return window.fpi
        .executeGQL(CHECKOUT_CART, Object.assign({ cartCheckoutDetailRequestInput: options }, ((buyNow && { buyNow }) || {})))
        .then((response) => {
