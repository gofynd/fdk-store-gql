...
export function transactOrder(paymentOptions, state) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((_b = (_a = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _a === void 0 ? void 0 : _a.checkoutCart) === null || _b === void 0 ? void 0 : _b.success) {
            ...
            (_d = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _d === void 0 ? true : delete _d.token;
            ...
            let rbiGuidelineSave = Object.assign(Object.assign({}, (isLoggedIn
                ? {
                    checkedBoxValue: (_e = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _e === void 0 ? void 0 : _e.is_card_secure,
                }
                : { checkedBoxValue: false })), { paymentdata: Object.assign(Object.assign({}, paymentOptions), { option: {
                        card_number: ((_f = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _f === void 0 ? void 0 : _f.card_token)
                            ? ""
                            : (_g = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _g === void 0 ? void 0 : _g.card_number,
                    } }) });
...
function createOrder(paymentOptions) {
    ...
    return window.fpi.executeGQL(CHECKOUT_CART, Object.assign({ cartCheckoutDetailRequestInput: options }, (buyNow && { buyNow } || {})));
}
