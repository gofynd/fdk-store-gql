...
function getCurrentPaymentGateway(paymentOptions) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const cached = window.currentPaymentGateway[paymentOptions.aggregator];
        if (cached) {
            if (String(paymentOptions.aggregator || "").toLowerCase() === "juspay" &&
                paymentOptions.payment) {
                cached.selectedPayment = paymentOptions.payment;
                cached.paymentFlow = paymentOptions.payment.paymentFlowMeta;
                if (cached.injectScript) {
                    yield cached.injectScript();
                }
            }
            return cached;
        }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if ((orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.success) || ((_b = (_a = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _a === void 0 ? void 0 : _a.checkoutCart) === null || _b === void 0 ? void 0 : _b.success)) {
            if (!(paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.enableLinkPaymentOption)) {
                // Reset ordering store in case of successful checkout
                removeCookie("m_orderingStore");
                const isJuspayAggregator = ((_c = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.aggregator) === null || _c === void 0 ? void 0 : _c.toLowerCase()) === "juspay" &&
                    (paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment_mode) === "CARD";
                const isJuspayNewCardPayV3 = isJuspayAggregator &&
                    !((_d = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _d === void 0 ? void 0 : _d.card_token) &&
                    !((_e = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _e === void 0 ? void 0 : _e.card_number);
                const isJuspaySavedCardPayV3 = isJuspayAggregator &&
                    ((_f = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _f === void 0 ? void 0 : _f.card_token) &&
                    !((_g = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _g === void 0 ? void 0 : _g.card_security_code);
                const isJuspayPayV3 = isJuspayNewCardPayV3 || isJuspaySavedCardPayV3;
                if (!isJuspayPayV3) {
                    orderInfo = updateOrderInfo(currentPaymentGateway, (_h = orderInfo.data) === null || _h === void 0 ? void 0 : _h.checkoutCart, paymentOptions);
                }
            }
            ...
            let rbiGuidelineSave = Object.assign(Object.assign({}, (isLoggedIn
                ? {
                    checkedBoxValue: (_j = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _j === void 0 ? void 0 : _j.is_card_secure,
                }
                : { checkedBoxValue: false })), { paymentdata: Object.assign(Object.assign({}, paymentOptions), { option: {
                        card_number: ((_k = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _k === void 0 ? void 0 : _k.card_token)
                            ? (_l = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _l === void 0 ? void 0 : _l.card_number
                            : "",
                    } }) });
