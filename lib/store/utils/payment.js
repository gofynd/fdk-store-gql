...
export function transactSplit(paymentOptions, state) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        const paymentOrderInput = Object.assign({ order_id: paymentOptions.order_id, payment_methods: [
                Object.assign({ amount: paymentOptions.amount, mode: paymentOptions.payment_mode, name: paymentOptions.name || paymentOptions.payment_mode, payment: "required", meta: {
                        merchant_code: paymentOptions.merchant_code,
                        payment_gateway: paymentOptions.aggregator,
                        payment_identifier: paymentOptions.payment_identifier,
                    } }, (paymentOptions.payment_extra_identifiers
        ...
        try {
            emitFPIEvent(FPI_EVENTS.ADD_PAYMENT_INFORMATION, {
                amount: Number.isFinite(Number((_b = orderData === null || orderData === void 0 ? void 0 : orderData.data) === null || _b === void 0 ? void 0 : _b.amount))
                    ? Number(orderData.data.amount) / 100
                    : undefined,
                currency: (_c = orderData === null || orderData === void 0 ? void 0 : orderData.data) === null || _c === void 0 ? void 0 : _c.currency,
                payment_mode: paymentOptions.payment_mode,
                aggregator: paymentOptions.aggregator,
        ...
        if ((_d = orderInfo === null || orderInfo === void 0 ? void 0 : orderInfo.data) === null || _d === void 0 ? void 0 : _d.card_token) {
            delete orderInfo.data.card_token;
        }
        orderInfo.data.upi_app = paymentOptions.upi_app;
        const rbiGuidelineSave = {
            checkedBoxValue: ((_e = state === null || state === void 0 ? void 0 : state.auth) === null || _e === void 0 ? void 0 : _e.logged_in)
                ? (_f = paymentOptions === null || paymentOptions === void 0 ? void 0 : paymentOptions.payment) === null || _f === void 0 ? void 0 : _f.is_card_secure
                : false,
