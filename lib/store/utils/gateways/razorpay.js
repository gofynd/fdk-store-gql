export default class RazorpayPayment {
    ...
    transaction(obj, consent) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            // Razorpay's checkout rejects these as extra fields ("... is/are not
            // required and should not be sent"). They are present on the split-payment
            // order data (PaymentOrderData); drop them before createPayment.
            delete data.aggregator;
            delete data.merchant_order_id;
            delete data.merchant_transaction_id;
