...
const logisticSlice = createSlice({
    ...
    reducers: {
        ...
        setlocality(state, action) {
            ...
            const locationData = Object.assign(Object.assign(Object.assign(Object.assign({}, (loactionDataCookie || {})), (((_b = action.payload) === null || _b === void 0 ? void 0 : _b.locality) && ((_c = action.payload) === null || _c === void 0 ? void 0 : _c.localityValue)
                ...
                : {}));
            if (!locationData.city && (locationObj === null || locationObj === void 0 ? void 0 : locationObj.city)) {
                locationData.city = locationObj === null || locationObj === void 0 ? void 0 : locationObj.city;
            }
            setCookie(COOKIE_KEYS.LOCATION_DATA, locationData, 1);
