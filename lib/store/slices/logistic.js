...
const logisticSlice = createSlice({
    ...
    reducers: {
        ...
        setlocality(state, action) {
            var _a, _b, _c;
            const locationObj = (_b = (_a = action.payload) === null || _a === void 0 ? void 0 : _a.localities) === null || _b === void 0 ? void 0 : _b.call(_a, (acc, curr) => {
                acc[curr.type] = curr.name;
                return acc;
            }, {});
            const locationData = Object.assign({ country: (locationObj === null || locationObj === void 0 ? void 0 : locationObj.country) || "India", city: locationObj === null || locationObj === void 0 ? void 0 : locationObj.city }, (((_c = action.payload) === null || _c === void 0 ? void 0 : _c.locality) === 'pincode' ? { pincode: action.payload.localityValue } : {}));
            setCookie(COOKIE_KEYS.LOCATION_DATA, locationData, 1);
            state.pincode_details = action.payload;
        }
    },
