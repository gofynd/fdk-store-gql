...
const pdpSlice = createSlice({
    ...
    reducers: {
        ...
        setproductPriceFO(state, action) {
            state.product_price_with_fullfillment = action.payload;
        },
    ...
    extraReducers: (builder) => {
        builder.addCase(`${STORE_KEYS.PRODUCT_DETAILS}/setData`, (state, action) => {
            Object.assign(state, action.payload);
        });
    },
});
export const pdpReducer = pdpSlice.reducer;
export const { setProduct, setfollowerCount, setproductSellers, setproductPrice, setproductPriceFO, setcompareWithFrequentlyCompared, setProductVariants, setbulkDiscountOffers, setFollowListing, setcompareSimilarProduct, setfollowedProducts, } = pdpSlice.actions;
