...
export const fetchAppliedTheme = createAsyncThunk("appliedTheme", (params, { extra }) => __awaiter(void 0, void 0, void 0, function* () {
    return params;
}));
...
const themeSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            state.theme = Object.assign(Object.assign({}, action.payload), { error: null, loading: false });
        })
            .addCase(fetchAppliedTheme.rejected, (state, action) => {
            state.theme = Object.assign({}, { error: action.error, loading: false });
        })
            //theme by id
            ...
            state.page = Object.assign(Object.assign({}, action.payload), { error: null, loading: false });
        })
            .addCase(fetchPage.rejected, (state, action) => {
            state.page = Object.assign({}, { error: action.error, loading: false });
        });
    },
});
