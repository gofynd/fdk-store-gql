...
export const checkoutPayment = createAsyncThunk("checkoutPayment", (payload, { extra, getState, rejectWithValue }) => __awaiter(void 0, void 0, void 0, function* () {
    const { cart_id, payment, meta, custom_meta, paymentflow = {}, address_id = null, billing_address_id = null, aggregator_name, payment_identifier = "", payment_extra_identifiers, payment_mode, queryParams, upi_app = "", buy_now = null, data, enableLinkPaymentOption = false, success = false, billing_address = {}, payment_methods = [], } = payload;
    const mutablePayment = Object.assign({}, payment);
    if (mutablePayment.payment_meta) {
        // Only for backword compatiblity
        mutablePayment.paymentFlowMeta = payment.payment_meta;
    ...
    const paymentOptions = enableLinkPaymentOption ?
        ...
        : Object.assign(Object.assign(Object.assign(Object.assign({ address_id: address_id || queryParams.address_id, billing_address_id: billing_address_id ||
                queryParams.billing_address_id ||
                queryParams.address_id, aggregator: aggregator_name || queryParams.aggregator_name, payment_identifier: payment_identifier || (queryParams === null || queryParams === void 0 ? void 0 : queryParams.payment_identifier), payment_mode: payment_mode || queryParams.payment_mode, callback_url: window.location.origin + "/cart/order-status", payment: mutablePayment, payment_extra_identifiers,
            meta,
            data,
            enableLinkPaymentOption }, (cart_id ? { id: cart_id } : {})), (custom_meta && custom_meta.length > 0 ? { custom_meta } : {})), { ordering_store: undefined, upi_app: upi_app, buy_now,
            payment_methods }), (billing_address ? { billing_address } : {}));
    ...
    try {
        if (paymentOptions.payment_mode === "COD" || paymentOptions.payment_mode === "PP" || paymentOptions.payment_mode === "CREDITNOTE") {
        ...
        else if (paymentOptions.payment_mode === "UPI" && (!upi_app && paymentOptions.aggregator !== "Razorpay")) {
