...
export const checkoutPayment = createAsyncThunk("checkoutPayment", (payload, { extra, getState, rejectWithValue }) => __awaiter(void 0, void 0, void 0, function* () {
    const { cart_id, payment, meta, custom_meta, paymentflow, address_id, billing_address_id, aggregator_name, payment_identifier = "", payment_extra_identifiers, payment_mode, queryParams, upi_app = "", buy_now = null, data, enableLinkPaymentOption, success = false, billing_address = {}, } = payload;
    const mutablePayment = Object.assign({}, payment);
    ...
    const paymentOptions = enableLinkPaymentOption ?
        ...
        : Object.assign(Object.assign(Object.assign(Object.assign({ address_id: address_id || queryParams.address_id, billing_address_id: billing_address_id ||
            ...
            meta,
            data,
            enableLinkPaymentOption }, (cart_id ? { id: cart_id } : {})), (custom_meta && custom_meta.length > 0 ? { custom_meta } : {})), { ordering_store: undefined, upi_app: upi_app, buy_now }), (billing_address ? { billing_address } : {}));
    if (!enableLinkPaymentOption) {
