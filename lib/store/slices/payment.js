...
export const checkoutPayment = createAsyncThunk("checkoutPayment", (payload, { extra, getState, rejectWithValue }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const paymentOptions = enableLinkPaymentOption ? Object.assign({ aggregator: aggregator_name || queryParams.aggregator_name, payment_identifier: payment_identifier || (queryParams === null || queryParams === void 0 ? void 0 : queryParams.payment_identifier), payment_mode: payment_mode || queryParams.payment_mode, payment: mutablePayment, payment_extra_identifiers,
        meta,
        data,
        enableLinkPaymentOption, ordering_store: ordering_store, staff, upi_app: upi_app, success: success }, (order_tags ? { order_tags } : {})) : Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ address_id: address_id || queryParams.address_id, billing_address_id: billing_address_id ||
        ...
        meta,
        data,
        enableLinkPaymentOption }, (cart_id ? { id: cart_id } : {})), (custom_meta && custom_meta.length > 0 ? { custom_meta } : {})), { ordering_store: ordering_store, staff, upi_app: upi_app, buy_now, locale: locale && locale !== "en" ? locale : "", payment_methods }), (billing_address ? { billing_address } : {})), (delivery_address ? { delivery_address } : {})), (order_tags ? { order_tags } : {}));
...
export const createSplitOrder = createAsyncThunk("createSplitOrder", (payload, { rejectWithValue }) => __awaiter(void 0, void 0, void 0, function* () {
    var _c, _d, _e, _f;
    const { cart_id, address_id = null, billing_address_id = null, billing_address = null, delivery_address = null, aggregator_name = "Fynd", payment = {}, paymentflow = {}, success_callback_url, failure_callback_url, meta, custom_meta, order_type, ordering_store, staff, buy_now = null, order_tags, } = payload;
    const mutablePayment = Object.assign({}, payment);
    if (mutablePayment.payment_meta) {
        mutablePayment.paymentFlowMeta = payment.payment_meta;
    }
