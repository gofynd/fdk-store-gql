...
import { brandsReducer, fetchBrands } from "./slices/brands";
...
class ApplicationStore {
    ...
    executeGraphQL(query, slug, params) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          `,
                ...
                const responseData = JSON.stringify(finalQuery.data);
                ...
                keys === null || keys === void 0 ? void 0 : keys.forEach((element) => {
                    if (element != null) {
                        ...
                        switch (element) {
                            ...
                            //Brands
                            case "brand":
                                this.dispatch(fetchBrands(queryResponse.brand));
                                return;
                            //Cart
                            case "cart":
                            ...
                            case "productLadderPromotion":
                                ...
                                return;
                            case "getCoupons":
                                this.dispatch(fetchCoupons(queryResponse.getCoupons));
                                return;
                            ...
                            case "getCart":
                                ...
                                return;
                            case "updateCart":
                                this.dispatch(updateCartItems(queryResponse.updateCart));
                                return;
    ...
    extractJsonKeys(jsonString, depth) {
        try {
