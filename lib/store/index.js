...
class ApplicationStore {
    ...
    executeFetch(query, variables) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const orderingSource = this.orderingSource || 'storefront';
            const response = yield fetch(`${this.domain}/service/application/graphql/`, {
                method: "POST",
                headers: Object.assign({ "Content-Type": "application/json", Authorization: this.authorizationHeader, 'x-ordering-source': orderingSource }, (isClient
                    ? {
                        credentials: "include",
                    }
                    : {
    ...
    setOrderingSource(orderingSource) {
        if (orderingSource && typeof orderingSource === 'string') {
            this.orderingSource = orderingSource;
        }
    }
