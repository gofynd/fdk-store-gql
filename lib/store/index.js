...
class ApplicationStore {
    ...
    executeFetch(query, variables) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const orderingSource = (_a = this.initialData.custom) === null || _a === void 0 ? void 0 : _a['orderingSource'];
            const response = yield fetch(`${this.domain}/service/application/graphql/`, {
                method: "POST",
                headers: Object.assign(Object.assign({ "Content-Type": "application/json", Authorization: this.authorizationHeader }, (orderingSource ? { 'x-ordering-source': orderingSource } : {})), (isClient
                    ? {
                        credentials: "include",
                    }
                    : {
