...
class ApplicationStore {
    ...
    executeGraphQL(query, slug, params) {
        return __awaiter(this, void 0, void 0, function* () {
            console.warn("executeGraphQL function is deprecated and might be removed in newer versions. Please start using the executeGQL function");
            let parseQuery = parse(query);
            try {
                const finalQuery = yield this.executeFetch(query, { slug });
    ...
    executeGQL(query, params, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const responseData = yield this.executeFetch(query, params);
