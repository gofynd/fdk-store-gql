    ...
    getServerCookies() {
        try {
            return Object.entries(this.serverCookies)
                .map(([key, value]) => `${key}=${typeof value === "object" ? JSON.stringify(value) : value}; Secure; SameSite=None;`)
                .join("; ");
        }
        catch (error) {
            console.error("Error while serializing server cookies");
            return "";
        }
    }
            ...
            try {
                ...
                if (!(options === null || options === void 0 ? void 0 : options.skipStoreUpdate)) {
                    if (((_b = (_a = parse(query).definitions) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.operation) === "mutation") {
                        mutationResponseHandler(responseData.data, this.dispatch, params, this.store.getState());
                    }
                    else {
                        queryResponseHandler(responseData.data, this.dispatch, params, this.store.getState());
                    }
                }
                return responseData;
            }
