...
const i18nDetailsKey = Symbol('i18nDetails');
const locationDetailsKey = Symbol('locationDetails');
class ApplicationStore {
    constructor(initialData, authorizationHeader, domain) {
        ...
        this.getters = {
            ...
            i18_DETAILS: (store) => store.custom[i18nDetailsKey],
            // Custom Getters
    ...
    setI18nDetails(cookieValue) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (typeof currentLocationData !== "object" || currentLocationData === null) {
                    currentLocationData = {};
                }
                currentLocationData.country_iso_code = cookieValue.countryCode || currentLocationData.country_iso_code;
                currentLocationData.country = cookieValue.countryName || currentLocationData.country;
