...
export type AggregatorsConfigDetail = {
    ...
    ajiodhan?: Maybe<AjiodhanAggregatorConfig>;
    ...
    /** Potlee config detail schema. */
    potlee?: Maybe<PotleeAggregatorConfig>;
    qr_refund_jiopay?: Maybe<QrRefundJioPayAggregatorConfig>;
...
export type AjiodhanAggregatorConfig = {
    __typename?: 'AjiodhanAggregatorConfig';
...
export type ApplicationContent = {
    ...
    supportInformation?: Maybe<SupportInformation>;
...
export type AppliedPromotion = {
    ...
    original_article_quantity?: Maybe<Scalars['Int']['output']>;
    ...
    promotion_type?: Maybe<Scalars['String']['output']>;
    return_allowed?: Maybe<Scalars['Boolean']['output']>;
};
...
/** Block within a section, containing various properties. */
export type Block = {
    __typename?: 'Block';
    /** The name of the block. */
    name?: Maybe<Scalars['String']['output']>;
...
export type CartLastModified = {
    __typename?: 'CartLastModified';
    /** Boolean to indentify operation was successfull or not */
    success?: Maybe<Scalars['Boolean']['output']>;
};
...
export type Collection = {
    ...
    /** SEO metadata for the collection. */
    seo?: Maybe<Seo>;
...
export type CompanyAddress = {
    ...
    /** Country code, e.g. +91. */
    country_code?: Maybe<Scalars['String']['output']>;
    /** Landmark near company. */
    landmark?: Maybe<Scalars['String']['output']>;
    /** Latitude and longitude coordinates of the company. */
...
export type CustomField = {
    ...
    key?: Maybe<Scalars['String']['output']>;
    /** Unique identifier for a custom object definition. */
...
export type DataLoaderDetail = {
    ...
    content?: Maybe<Scalars['String']['output']>;
    /** Timestamp when data loader was configured. */
    created_at?: Maybe<Scalars['String']['output']>;
    /** Unique identifier of an entry. */
    id?: Maybe<Scalars['String']['output']>;
    /** Whether data loader is enabled or not. */
    is_selected?: Maybe<Scalars['Boolean']['output']>;
    /** Timestamp when data loader was updated. */
...
export type IfscCodeDetail = {
    ...
    CENTRE?: Maybe<Scalars['String']['output']>;
    CITY?: Maybe<Scalars['String']['output']>;
    CONTACT?: Maybe<Scalars['String']['output']>;
    DISTRICT?: Maybe<Scalars['String']['output']>;
    IFSC?: Maybe<Scalars['String']['output']>;
    IMPS?: Maybe<Scalars['Boolean']['output']>;
    ISO3166?: Maybe<Scalars['String']['output']>;
    MICR?: Maybe<Scalars['String']['output']>;
    NEFT?: Maybe<Scalars['Boolean']['output']>;
    RTGS?: Maybe<Scalars['Boolean']['output']>;
    STATE?: Maybe<Scalars['String']['output']>;
    UPI?: Maybe<Scalars['Boolean']['output']>;
    /** Bank Name Of Account. */
    bank_name: Scalars['String']['output'];
    /** Branch Name Of Account. */
...
export type JusPayAggregatorConfig = {
    ...
    /** Used for payment gateway webhook signature verification. */
...
/** Provides information about stores. */
export type Locations = {
    __typename?: 'Locations';
    /** List of locations, each containing detailed information about individual store. */
...
export type MSwipeAggregatorConfig = {
    ...
    /** Fynd or self payment gateway. */
    config_type?: Maybe<Scalars['String']['output']>;
    /** Whether payment gateway is active or not. */
    is_active?: Maybe<Scalars['Boolean']['output']>;
    /** Payment gateway api key. */
    key?: Maybe<Scalars['String']['output']>;
    /** Unique merchant id. */
...
export type Payment = {
    ...
    activeCardAggregator?: Maybe<ActiveCardAggregator>;
...
export type PaymentFlows = {
    ...
    openapi?: Maybe<PaymentFlowDetail>;
    /** PayUbiz Payment flow object. */
    payubiz?: Maybe<PaymentFlowDetail>;
    payumoney?: Maybe<PaymentFlowDetail>;
    pinelabs?: Maybe<PaymentFlowDetail>;
    potlee?: Maybe<PaymentFlowDetail>;
...
export type PaymentModeList = {
    ...
    /** Payment Mode Logo. */
    logo_url?: Maybe<Logo>;
    max_cart_value?: Maybe<Scalars['Float']['output']>;
    /** Unique code identifying the merchant. */
    merchant_code?: Maybe<Scalars['String']['output']>;
    min_cart_value?: Maybe<Scalars['Float']['output']>;
    /** User's name. */
    name?: Maybe<Scalars['String']['output']>;
    /** User-defined name for the card. */
    nickname?: Maybe<Scalars['String']['output']>;
...
export type PayuMoneyAggregatorConfig = {
    ...
    /** Payment gateway api endpoint. */
    api_domain?: Maybe<Scalars['String']['output']>;
    /** Redirect to checkout formpost url for accepting payments. */
...
export type ProductBrand = {
    ...
    description?: Maybe<Scalars['String']['output']>;
    /** unique id for the product brand. */
    id?: Maybe<Scalars['Int']['output']>;
...
export type ProductSeo = {
    ...
    /** List of action objects which can power breadcrumbs on website. */
    breadcrumbs?: Maybe<Scalars['JSON']['output']>;
...
export type QrRefundJioPayAggregatorConfig = {
    __typename?: 'QRRefundJioPayAggregatorConfig';
    api_domain?: Maybe<Scalars['String']['output']>;
    checkout_formpost_url?: Maybe<Scalars['String']['output']>;
    config_type?: Maybe<Scalars['String']['output']>;
    is_active?: Maybe<Scalars['Boolean']['output']>;
...
export type Query = {
    ...
    cartLastModified?: Maybe<CartLastModified>;
...
export type QueryCartLastModifiedArgs = {
    id?: InputMaybe<Scalars['String']['input']>;
};
...
export type RazorPayAggregatorConfig = {
    ...
    vpa?: Maybe<Scalars['String']['output']>;
    /** Secret required for Payment Gateway webhook verification. */
...
/** Schema to get details about Support entities like custom form and support ticket. */
export type SupportCustomFormArgs = {
    slug: Scalars['String']['input'];
};
/** Schema to get details about Support entities like custom form and support ticket. */
...
/** Object containig theme images data. */
export type ThemeImages = {
    ...
    /** Object containig thumbnail image options. */
