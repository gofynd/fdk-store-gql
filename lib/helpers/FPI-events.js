...
export const FPI_EVENTS = {
    ...
    PRODUCT_LIST_VIEW: {
        ...
        payloadCreator: (result, param, store) => {
            return { items: result === null || result === void 0 ? void 0 : result.items, page: result === null || result === void 0 ? void 0 : result.page };
        },
    },
    ...
    SEARCH_PRODUCTS: {
        ...
        payloadCreator: (result, param, store) => {
            return { items: result === null || result === void 0 ? void 0 : result.items, search_text: param === null || param === void 0 ? void 0 : param.query, source: 'autocomplete' };
        },
    },
...
export function getPrimaryVerifiedValue(items = []) {
    if (!Array.isArray(items) || items.length === 0)
        return null;
    return items.find((x) => (x === null || x === void 0 ? void 0 : x.primary) === true && (x === null || x === void 0 ? void 0 : x.verified) === true) || items[0];
}
