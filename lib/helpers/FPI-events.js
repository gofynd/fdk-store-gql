...
export const FPI_EVENTS = {
    ...
    ORDER_CHECKEDOUT: {
        ...
        payloadCreator: (result, param, store, oldStore) => {
            ...
            eventData.is_split = (_g = param === null || param === void 0 ? void 0 : param.is_split) !== null && _g !== void 0 ? _g : false;
            return eventData;
        },
    },
    ADD_PAYMENT_INFORMATION: {
        ...
        payloadCreator: (result, param) => {
            var _a, _b, _c, _d, _e, _f, _g;
            // Classic flow passes the checkoutCart response (cart breakup under
            // result.data.checkoutCart.cart); split passes the createPaymentOrder
            // response (no cart), so coupon/delivery are dropped for split.
            const cart = (_b = (_a = result === null || result === void 0 ? void 0 : result.data) === null || _a === void 0 ? void 0 : _a.checkoutCart) === null || _b === void 0 ? void 0 : _b.cart;
            return Object.assign({ value: param === null || param === void 0 ? void 0 : param.amount, payment: {
                    payment_mode: param === null || param === void 0 ? void 0 : param.payment_mode,
                    payment_type: param === null || param === void 0 ? void 0 : param.payment_mode,
                    payment_gateway: param === null || param === void 0 ? void 0 : param.aggregator,
                }, currency_code: param === null || param === void 0 ? void 0 : param.currency, cart: { cart_id: (_c = param === null || param === void 0 ? void 0 : param.cart_id) !== null && _c !== void 0 ? _c : null }, order_id: (_d = param === null || param === void 0 ? void 0 : param.order_id) !== null && _d !== void 0 ? _d : null, is_split: (_e = param === null || param === void 0 ? void 0 : param.is_split) !== null && _e !== void 0 ? _e : false }, (cart
                ? {
                    coupon: { coupon_code: (_g = (_f = cart === null || cart === void 0 ? void 0 : cart.breakup_values) === null || _f === void 0 ? void 0 : _f.coupon) === null || _g === void 0 ? void 0 : _g.code },
                    delivery_charges: cart === null || cart === void 0 ? void 0 : cart.delivery_charge_info,
                }
                : {}));
        },
    },
